...
const placeOrder = async (req, res) => {
  const fronted_url = "http://food-delivery-website-fronted-6gry.onrender.com";
  try {
    ...
    }); // to verify the order this is not a perfect way, the perfect way is vebhux.
...
const userOrders = async (req, res) => {
  try {
    // find all orders using their userId
...
// find all the orders from all users
